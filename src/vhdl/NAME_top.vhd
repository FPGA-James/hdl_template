...
-- Designer     : <name>
--
-- Filename     : <<NAME>>_top.vhd
--
-- Purpose      : Integrates the AXI4-Lite register block (generated by
--                hdl_registers) with the <<NAME>>_core logic; wires decoded
--                register values to the core and status back to the
--                register block.
--
