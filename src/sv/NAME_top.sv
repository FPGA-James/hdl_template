...
// Designer     : <name>
//
// Filename     : <<NAME>>_top.sv
//
// Purpose      : Integrates the AXI4-Lite register file (generated by
//                hdl_registers + PeakRDL-regblock) with the <<NAME>>_core
//                logic; wires decoded register values to the core and
//                status back to the register file.
//
